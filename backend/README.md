...
## Project Structure
    ...
    ├── ideapros_llc_recite_31958  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_recite_31958`
...
2. Clone this repo and `cd ideapros_llc_recite_31958`
